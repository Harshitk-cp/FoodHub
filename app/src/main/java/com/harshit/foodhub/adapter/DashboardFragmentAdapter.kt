package com.harshit.foodhub.adapter
...
import com.harshit.foodhub.R
import com.harshit.foodhub.activity.RestaurantMenuActivity
import com.harshit.foodhub.database.RestaurantDatabase
import com.harshit.foodhub.database.RestaurantEntity
import com.harshit.foodhub.model.Restaurant
...
class DashboardFragmentAdapter(val context: Context, var itemList: ArrayList<Restaurant>) :
    ...
    override fun onBindViewHolder(holder: ViewHolderDashboard, position: Int) {
        ...
        Picasso.get().load(restaurant.restaurantImage).error(R.drawable.rest_logo)
